...
public class MapBuilderTest {
    ...
    public void testMapBuilder() {
        ...
        List<DataItem> dataItems = builder.addMap().put(new UnicodeString("key"), new UnicodeString("value"))
            .put(1, true).put(2, "value".getBytes()).put(3, 1.0d).put(4, 1.0f).put(5, 1L).put(6, "value").put("7", true)
            .put("8", "value".getBytes()).put("9", 1.0d).put("10", 1.0f).put("11", 1L).put("12", "value").putMap(13)
            .end().putMap("14").end().putMap(new UnsignedInteger(15)).end().putArray(16).end().putArray("17").end()
            .putArray(new UnsignedInteger(18)).end().end().startMap().startArray(1).end()
            .startArray(new UnsignedInteger(2)).end().end().build();
