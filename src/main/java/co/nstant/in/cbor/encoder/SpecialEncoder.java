...
public class SpecialEncoder extends AbstractEncoder<Special> {
    ...
    private HalfPrecisionFloatEncoder halfPrecisionFloatEncoder;
    private SinglePrecisionFloatEncoder singlePrecisionFloatEncoder;
    private DoublePrecisionFloatEncoder doublePrecisionFloatEncoder;

    public SpecialEncoder(CborEncoder encoder, OutputStream outputStream) {
        super(encoder, outputStream);
        halfPrecisionFloatEncoder = new HalfPrecisionFloatEncoder(encoder,
                        outputStream);
        singlePrecisionFloatEncoder = new SinglePrecisionFloatEncoder(encoder,
                        outputStream);
        doublePrecisionFloatEncoder = new DoublePrecisionFloatEncoder(encoder,
                        outputStream);
    }
