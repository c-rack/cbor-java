...
public class SpecialDecoder extends AbstractDecoder<Special> {
    ...
    public SpecialDecoder(CborDecoder decoder, InputStream inputStream) {
        ...
        this.halfPrecisionFloatDecoder = new HalfPrecisionFloatDecoder(decoder,
                        inputStream);
        this.singlePrecisionFloatDecoder = new SinglePrecisionFloatDecoder(
                        decoder, inputStream);
        this.doublePrecisionFloatDecoder = new DoublePrecisionFloatDecoder(
                        decoder, inputStream);
    }
